...
#### Main code --------------------------------
par(xpd = TRUE,mar = c(0, 1, 1.0, 0)+.1, oma = c(0,0,0,0)) # decrease default margin
...
par(xpd = TRUE,mar = c(0, 1, 1.0, 0)+.1) # decrease default margin
layout(matrix(1:10, nrow = 2, byrow = T)) # draw 10 plots
allradar("1hour")
png(filename = "1hourp.png",
    width = 1500, height = 1000, units = "px", pointsize = 30,
     bg = "white")
